...
let info =
  [ "project-name", "KineticMonitor"
    "project-author", "Ignacio Corderi"
    "project-summary", "A monitor service for Kinetic devices"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/KineticMonitor" ]
